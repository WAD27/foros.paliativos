	...
	<header id="encabezado" class="cell">
		...
		<div class="grid-container">
			...
			<div id="logo" class="titulo grid-x small-6 medium-5">
				<div id="logo-texto" class="titulo">
					<a href="index.php">VI FORO DE CUIDADOS PALIATIVOS</a>
				</div>
			</div>
			...
			<nav id="menu" class="grid-x small-6 medium-7">
				...
				<ul id="menu-lista" class="cell hide-for-small-only">
					...
					<li id="registro_menu" class="registro_menu menus"><a href="https://docs.google.com/forms/d/17hmdcY0_RC_Liqv8o5-7kXNlnXTScvdkr_8D2oxL234/viewform?ts=5aa73ce9&edit_requested=true">Registro</a></li>
		...
		<div id="menu-movil" class="grid-x">
			...
			<ul id="menu-lista-movil" class="row align-center show-for-small-only">
				...
				<li id="registro_menu-movil" class="registro_menu columns small-3 menus"><a href="https://docs.google.com/forms/d/17hmdcY0_RC_Liqv8o5-7kXNlnXTScvdkr_8D2oxL234/viewform?ts=5aa73ce9&edit_requested=true">Registro</a></li>
...
<section id="programa" class="grid-container screens">
	...
	<div class="grid-x pdf">
		<center>
			<object data="assets/vi.foro.de.cuidados.paliativos.pdf" type="application/pdf" class="hide-for-small-only">
				alt : <a href="assets/vi.foro.de.cuidados.paliativos.pdf">Cuidados Paliativos</a>
			</object>

			<!-- <iframe src="http://foropaliativosgea.com/assets/vi.foro.de.cuidados.paliativos.pdf"	width="100%" style="height:100vh;z-index:10000;border:none;" class="show-for-small-only">
			[Tu navegador <em>no</em> soporta <code>iframe</code>,o ha sido configurado para no visualizarlos.
			<a href="assets/vi.foro.de.cuidados.paliativos.pdf">
				Descarga el programa
			</a>.]
			</iframe> -->
			<div class="cell small-12 text-center show-for-small-only" style="padding-top:70px;padding-bottom:100px;" >
		Tu navegador <em>no</em> soporta archivos PDF, o ha sido configurado para no visualizarlos.
			<a href="assets/vi.foro.de.cuidados.paliativos.pdf" style="font-weight:bold;color:lightgray;">
				Dá click aquí para descargar el programa a tu teléfono
			</a>.
		</div>
	...
	<div class="grid-x padding-x">
		...
		<div id="contacto_info" class="cell small-12 medium-7">
			...
			<p id="info-contacto">
				...
				<i class="fas fa-envelope"></i><span> paliativosgea@gmail.com</span><br><br>
			</p>
		</div>
...
<footer id="footer" class="cell">
	<div class="grid-container">
		...
		<div id="redes" class="small-12 medium-3 grid-x footer-item text-center">
